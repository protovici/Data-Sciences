...
# Data location:  https://www.kaggle.com/budincsevity/szeged-weather?select=weatherHistory.csv

class Model:
    def __init__(self, datafile = r'C:\ds_dev\oop_dev\machine_learning\data\weatherHistory.csv', model_type = None):
